...
/* -----------------------------------------------------------------------------
    ...
    Write the code that will ensure the variable "differans" contains the difference of all the numbers in the list (i.e., tal1 - tal2 - tal3 - tal4 - 
    ... and so on).
*/
console.log("Task: C");
...
function differansier(liste) {
    let sumAndreTallListe = liste[0];
    for (let i = 1; i < liste.length; i++) {
        sumAndreTallListe -= liste[i];
    }
    return sumAndreTallListe;
}
